export const ANALYZE_STR_MARKET_INPUT_SCHEMA = {
    ...
    amenityGapAnalysis: {
      ...
      properties: {
        topPerformerAmenities: {
          type: "array",
          description: "Amenities most common among top-rated listings",
          items: {
            type: "object",
            properties: {
              amenity: {
                type: "string",
                description: "Amenity name (e.g., 'Pool', 'Hot tub', 'Wifi')",
              },
              prevalenceTopPerformers: {
                type: "number",
                description: "% of top performers with this amenity",
              },
              prevalenceAll: {
                type: "number",
                description: "% of all listings with this amenity",
              },
            },
        ...
        recommendedAmenities: {
          type: "array",
          description:
            "Amenities with biggest gap between top performers and average â€” the best ROI amenities to add",
          items: { type: "string" },
        },
      },
    ...
    topComparables: {
      ...
      items: {
        ...
        properties: {
          ...
          roomType: {
            type: "string",
            description: "Type of room (entire_home, private_room)",
          },
          isGuestFavorite: {
            type: "boolean",
            description: "Whether listing has Guest Favorite badge",
          },
        },
...
export const ANALYZE_STR_MARKET_TOOL = {
  ...
  inputSchema: ANALYZE_STR_MARKET_INPUT_SCHEMA,
  outputSchema: ANALYZE_STR_MARKET_OUTPUT_SCHEMA,
  _meta: {
    context: [
...
export const TOOLS = [ANALYZE_STR_MARKET_TOOL];
